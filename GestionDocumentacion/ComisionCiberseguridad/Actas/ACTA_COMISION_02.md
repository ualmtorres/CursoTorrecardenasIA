...
## Riesgos revisados
- Estado general de ciberseguridad: se considera estable.
- Parcheado de servidores: 91% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 2.
- Cuentas bloqueadas por actividad anomala en el mes: 14, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-03-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-03-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-03-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-03-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-03-10 | Recurrente |

## Estado de acciones previas
Inventario de servidores iniciado por Javier Ruiz. Revision de cuentas privilegiadas pendiente de cierre por Carlos Navarro.
