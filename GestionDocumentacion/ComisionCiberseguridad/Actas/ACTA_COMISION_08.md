...
## Riesgos revisados
- Estado general de ciberseguridad: se considera con mayor presion operativa.
- Parcheado de servidores: 84% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 13.
- Cuentas bloqueadas por actividad anomala en el mes: 38, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-09-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-09-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-09-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-09-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-09-10 | Recurrente |

## Estado de acciones previas
Segmentacion de imagen medica completada solo en subred de pruebas. Revision de privilegios al 43%.
