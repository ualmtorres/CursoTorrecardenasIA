...
## Riesgos revisados
- Estado general de ciberseguridad: se considera prioritaria.
- Parcheado de servidores: 78% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 21.
- Cuentas bloqueadas por actividad anomala en el mes: 56, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-12-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-12-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-12-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-12-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-12-10 | Recurrente |

## Estado de acciones previas
PAM y SOC externo siguen sin decision presupuestaria. AD heredado mantiene dependencias no documentadas.
