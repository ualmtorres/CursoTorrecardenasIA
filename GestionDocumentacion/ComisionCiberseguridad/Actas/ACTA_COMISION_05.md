...
## Riesgos revisados
- Estado general de ciberseguridad: se considera bajo seguimiento.
- Parcheado de servidores: 90% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 7.
- Cuentas bloqueadas por actividad anomala en el mes: 26, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-06-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-06-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-06-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-06-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-06-10 | Recurrente |

## Estado de acciones previas
Microsegmentacion de UCI y Laboratorio en diseno. Renovacion de controladores de dominio sin ventana aprobada.
