...
## Riesgos revisados
- Estado general de ciberseguridad: se considera estable con salvedades.
- Parcheado de servidores: 83% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 15.
- Cuentas bloqueadas por actividad anomala en el mes: 41, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-10-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-10-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-10-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-10-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-10-10 | Recurrente |

## Estado de acciones previas
Se corrigen reglas de firewall duplicadas. Persisten activos sin propietario en electromedicina.
