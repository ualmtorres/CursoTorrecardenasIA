...
## Riesgos revisados
- Estado general de ciberseguridad: se considera razonablemente controlada.
- Parcheado de servidores: 93% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 0.
- Cuentas bloqueadas por actividad anomala en el mes: 17, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-04-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-04-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-04-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-04-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-04-10 | Recurrente |

## Estado de acciones previas
SecureHealth entrega avance de vulnerabilidades. MFA piloto autorizado, pendiente de pruebas con Radiologia.
