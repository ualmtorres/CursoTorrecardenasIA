...
## Riesgos revisados
- Estado general de ciberseguridad: se considera en fase de refuerzo.
- Parcheado de servidores: 80% comunicado en el cuadro operativo de la reunion.
- Vulnerabilidades criticas abiertas declaradas en comision: 18.
- Cuentas bloqueadas por actividad anomala en el mes: 49, sin impacto asistencial reportado.
...
|---|---|---:|---|
| Actualizar backlog de parches y excepciones aprobadas | Laura Moreno | 2025-11-15 | Abierta |
| Revisar cuentas privilegiadas de administracion local | Carlos Navarro | 2025-11-20 | En curso |
| Validar reglas de segmentacion para redes clinicas | Pablo Martin | 2025-11-22 | En curso |
| Confirmar dependencias tecnicas de servidores heredados | Javier Ruiz | 2025-11-25 | Abierta |
| Informar de alertas relevantes de SecureHealth | David Vega | 2025-11-10 | Recurrente |

## Estado de acciones previas
SecureHealth confirma backlog de parches. Sustitucion VPN queda pendiente de propuesta economica.
